...
const EnhancedAgentCard: React.FC<EnhancedAgentCardProps> = ({
  ...
  const premiumCapabilities = capabilities.filter((cap) => cap.requiresMinting);
  ...
  return (
    ...
    >
      ...
      {/* Main card */}
      <div className="relative overflow-hidden rounded-2xl bg-black/50 backdrop-blur-xl border border-white/10 group-hover:border-white/20 transition-all duration-300">
            ...
            <div className="space-y-3">
              ...
              <div className="relative h-2 bg-white/10 rounded-full overflow-hidden">
                <motion.div
                  ...
                  animate={{
                    width: `${
                      (unlockedCapabilities.length / capabilities.length) * 100
                    }%`,
                  }}
                ...
                <motion.div
                  ...
                  animate={{
                    width: `${
                      (premiumCapabilities.length / capabilities.length) * 100
                    }%`,
                  }}
